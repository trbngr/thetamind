# defmodule Thetamind.Cqrs.DispatchStrategy.QueryStrategy do
...
#   alias Thetamind.Cqrs.QueryHandler
...
#   # scope? is set to true in Thetamind.Cqrs.AbsintheContextConfiguration
